...
def get_loc(message, text):
    ...
    if message.location:
        ...
        bot.send_invoice(
            ...
            provider_token='TOKEN',  # замени на реальный токен
            currency='UZS',
...
def successful_payment(message):
    ...
    # Отправка админу
    bot.send_message('ADMIN_USER', order_text)
    if loc:
        bot.send_location('ADMIN_USER', latitude=loc.latitude, longitude=loc.longitude)
